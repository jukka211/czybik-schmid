    ...
    <main className="max-w-3xl mx-auto p-6 space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-neutral-600">
          Bitte füllen Sie das Formular aus. Ohne Zustimmung bleibt der Absendebutton funktionslos.
        </p>
      </header>
...
>
        ...
        {/* 2. Behörde */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">2. Behörde</h2>
          <label className="space-y-1">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">3. Verbindliche Rechnungsanschrift</h2>
          <label className="space-y-1">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">4. E-Rechnung / XRechnung</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="space-y-1">
        ...
        {/* 5. Thema */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">5. Thema</h2>
          <label className="space-y-1">
        ...
        {/* 6. Ort */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">6. Ort</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">7. Datum und Zeitraum</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <label className="space-y-1">
              <span className="text-sm">Datum</span>
              <input className="w-full border rounded-md p-2" name="date" placeholder="TT.MM.JJJJ" required />
            </label>
            <label className="space-y-1">
              <span className="text-sm">Startzeit</span>
              <input className="w-full border rounded-md p-2" name="startTime" placeholder="HH:MM" required />
            </label>
            <label className="space-y-1">
              <span className="text-sm">Endzeit</span>
              <input className="w-full border rounded-md p-2" name="endTime" placeholder="HH:MM" required />
            </label>
          </div>
        </section>
        ...
        {/* 8. Bildanzahl */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">8. Bildanzahl</h2>
          <label className="space-y-1">
        ...
        {/* 9. Lieferdatum */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">9. Lieferdatum</h2>
          <label className="space-y-1">
        ...
        {/* 10. Liefermedium */}
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">10. Liefermedium</h2>
        ...
        <section className="space-y-3 border-t pt-6">
          ...
          <details className="text-sm text-neutral-700">
            ...
            <div className="mt-2 space-y-2">
              ...
              <p>
                Die Speicherung dieser Daten dient der Zuordnung der Anfrage und der anschließenden Beantwortung derselben.
