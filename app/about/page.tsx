...
async function getAboutData() {
  ...
  if (!data) {
    return {
      ...
      people: [
        {
          name: "Christina Czybik",
          website: "https://christinaczybik.photoshelter.com/",
        ...
        {
          name: "Laurin Schmid",
          website: "https://www.laurin-schmid.com/",
  ...
  return {
    ...
    people: (data.people ?? []).map((p: any) => ({
      ...
      photoUrl: p.photo
        ? urlFor(p.photo).width(800).quality(80).auto("format").url()
        : null,
      bioLeft: p.bioLeft,
      bioRight: p.bioRight,
    })),
